...
S_M = 5000  #Number of times simulations have to be conducted on one graph
...
#------------------------------------------------------Dynamics-----------------------------------------------------
change_percentage_add_nodes = 0.002 #Percentage of node additions expected in a graph per iteration (Dynamicity)
